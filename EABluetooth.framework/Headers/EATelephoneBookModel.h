...
/**
 * id = 42:
 * Mobile phone directory[Transfers the contact data model to the watch]
 * 手机通信录【向手表传输联系人数据模型】
 */
...
/// The contact that needs to be passed into the watch【需要传入手表的联系人】
@property(nonatomic,strong) NSMutableArray<EAContactModel*> *sIndexArray;


@property(nonatomic, readonly) NSUInteger sIndexArray_Count __attribute__((deprecated));
@property(nonatomic, assign) EAPhoneContactFlag eFlag __attribute__((deprecated));
...
/// Cell phone number array【手机号码数组】
