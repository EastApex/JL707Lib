...
/// Time formats：12h or 24h【小时制】
@property(nonatomic, assign) EATimeHourType timeHourType;

/// time zone:Time zone 0, East Time zone, West time zone【 当前时区：0时区、东时区、西时区】
@property(nonatomic, assign) EATimeZone timeZone;

/// The current time zone of hour【当前时区:时】
@property(nonatomic, assign) NSInteger timeZoneHour;

/// The current time zone of minute【当前时区:分】
@property(nonatomic, assign) NSInteger timeZoneMinute;

/// Synchronous mode:No setting required【同步模式】
@property(nonatomic, assign) EASyncType syncType;

/// time zone city name【时区城市名称】
@property(nonatomic, strong) NSString *place;


/// Get the current time return class EASyncTime，cac used to set the watch time【获取当前时间】
