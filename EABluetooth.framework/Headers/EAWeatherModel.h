...
/// A maximum of 8 days is supported【最多支持8天】
...
/// Weather Conditions (Day)【天气状况 （日间）：如果不需要夜间天气，请将 eNightType 也设为 eDayType的值】
@property(nonatomic, assign) EAWeatherType eDayType;

/// Weather Conditions (night)【天气状况 （夜间）如果不需要夜间天气，请将 eNightType 也设为 eDayType的值】
